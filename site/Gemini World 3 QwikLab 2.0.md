...
Our agent will use this for reference as we continue development. AGY also renames your existing project to match the brief and updates the agent's persona, so you keep building on the *same* agent for the rest of the lab.
