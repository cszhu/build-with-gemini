...
Noting your credentials, right click **Lab Instructions** and select "Open Link in Incognito Window":
...
In the image-generation step below, your agent uploads each generated image to this bucket and gets back a public URL. A public URL is a plain `https` link that any browser can load, so the image can appear inside your agent's A2UI cards and in your custom frontend.
